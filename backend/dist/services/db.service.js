...
// Database Name
var dbName = (process.env.NODE_ENV === 'production') ? 'BIGDATA_BOUTIQUE' : 'INTERVIEW';
var dbConn = null;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, MongoClient.connect(dbURL, { useNewUrlParser: true, useUnifiedTopology: true })];
                case 2:
                    client = _a.sent();
                    db = client.db(dbName);
                    dbConn = db;
