...
function getMeetings(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, month, year, meetings, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, meeting_service_1.meetingService.query(month, year)];
                case 2:
                    meetings = _b.sent();
                    res.send(meetings);
                    return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, meeting_service_1.meetingService.getById(req.params.id)];
                case 1:
                    meeting = _a.sent();
                    res.send(meeting);
                    return [3 /*break*/, 3];
