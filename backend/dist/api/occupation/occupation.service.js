...
function query(year) {
    return __awaiter(this, void 0, void 0, function () {
        var collection, occupationsByDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dbService.getCollection('occupation')];
                case 1:
                    collection = _a.sent();
                    return [4 /*yield*/, collection.findOne({ "year": +year })];
                case 2:
                    occupationsByDate = (_a.sent()) || { "year": +year };
                    return [2 /*return*/, occupationsByDate];
            }
        });
    });
}
function save(meetingToSAve) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    meeting = __assign(__assign({}, meetingToSAve), { startDate: new Date(meetingToSAve.startDate), endDate: new Date(meetingToSAve.endDate) });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, _removeOccupiedHours(meeting._id, oldOccupationsByDate)];
                case 3:
                    occupationsByDate = _a.sent();
                    return [2 /*return*/, CheckTimeAndSave(meeting, occupationsByDate, collection)];
                case 4:
                    err_2 = _a.sent();
                    console.log(err_2);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, collection.replaceOne({ "year": meeting.startDate.getFullYear() }, newOccupationsByDate, { upsert: true })
...
function _removeOccupiedHours(id, occupationsByDate) {
    return __awaiter(this, void 0, void 0, function () {
        var meeting, start, end, occHours, date, occupations;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, meeting_service_1.meetingService.getById(id)];
                case 1:
                    meeting = _b.sent();
                    start = new Date(meeting.startDate);
                    end = new Date(meeting.endDate);
                    occHours = new Array(end.getHours() - start.getHours()).fill('').map(function (a, idx) { return start.getHours() + idx; });
                    date = start.getMonth() + "-" + start.getDate();
                    occupations = occupationsByDate[date].filter(function (hour) { return !occHours.includes(hour); });
                    return [2 /*return*/, __assign(__assign({}, occupationsByDate), (_a = {}, _a[date] = occupations, _a))];
            }
        });
    });
}
