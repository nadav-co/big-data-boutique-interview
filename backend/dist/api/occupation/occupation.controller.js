...
var occupation_service_1 = require("./occupation.service");
function getOccupations(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, month, year, occupations, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, occupation_service_1.occupationService.query(year)];
                case 2:
                    occupations = _b.sent();
